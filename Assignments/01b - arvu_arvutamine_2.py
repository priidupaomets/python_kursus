...
Antud variandi erinevus võrreldes eelmisega on juhusliku arvu generaatori kasutamine algse
arvu välja mõtlemiseks
"""
import random

arvatav_arv = random.randint(1, 50) # Praegu me ei tea veel, kuidas juhuslikku arvu saada
katsete_arv = 0
arvatud = False
